...
class StartQuiz:
    ...
    def __init__(self):
        ...
        # choose_string = "Oops - Please choose a whole number between 1 and 100."
    ...
    def check_questions(self):
        ...
        # checks that the number entered is a whole number between 1 and MAX_QUESTIONS
        try:
            ...
            if 1 <= questions_wanted <= MAX_QUESTIONS:
                ...
                # Check we have enough questions in the file
...
class Play:
    ...
    def __init__(self, how_many, all_questions):
        ...
        # Shuffle and trim question list to requested number
        ...
        play_labels_list = [
            ...
            ["Select the correct nickname for the football club below.", body_font, "#D5E8D4", 2],
            ["", body_font, None, 5]
        ]
        ...
        # Retrieve next, hints and stats buttons so they can be configured
    ...
    def new_question(self):
        ...
        """
        # Reset hint variables for new question
        self.hints_used = 0
        self.hint1_used = False
        self.hint2_used = False
        ...
        # Update heading and club name labels
        ...
        # Build options: 1 correct + 3 random wrong answers from the pool
        ...
        # configure answer buttons with the options
    ...
    def show_hint_1(self):
        ...
        if not self.hint1_used:
            ...
            # Check if hint 2 was already used (ie: show both hints together)
            if self.hint2_used:
    ...
    def show_hint_2(self):
        ...
        if not self.hint2_used:
            ...
            # Check if hint 1 was already used (ie: show both hints together)
            if self.hint1_used:
                self.hint_label.config(
                    text="💡 Club Hint: {}\n🔍 Nickname Hint: {}".format(
                        self.current_hint_team, self.current_hint_nick))
    ...
    def check_answer(self, button_index):
        ...
        """
        # Get the answer the user chose based on button index
        chosen = self.current_options[button_index]

        # disable all answer buttons and hint buttons once answered
        for item in self.answer_buttons_ref:
        ...
        if chosen == self.current_answer:
            # score goes down by 1 for each hint used
            ...
            # subtract a point if hints were used and they got it wrong
    ...
    def quiz_over(self):
        ...
        percentage = round((questions_correct / self.total_questions) * 100)
        ...
        self.results_label.config(
            text=(
                f"{grade}\n\n"
                f"Final Score: {self.score}/{self.total_questions * 3}\n"
                f"Correct Answers: {questions_correct}/{self.total_questions}\n"
        ...
        self.hint_label.config(
            text="Open Statistics to see your full results."
        )

        self.end_quiz_button.config(
            text="Play Again",
            bg="#006600",
...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        # we don't have a comment we want it to be blank
        comment_alignment = "W"
        ...
        # Configure comment label background (for all correct / all wrong)
    ...
    def export_results(self, partner):
        ...
        """
        # use a timestamp so the file doesn't overwrite previous exports
        ...
        try:
            with open(filename, "w") as file:
                ...
                # write summary stats at the bottom
                file.write("\nSummary\n")
                file.write("-" * 40 + "\n")
